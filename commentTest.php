                            ...
                            <img src="<?php echo $image?>" alt="">
                                                        ...
                                                        <div class="we-comment">
                                                            ...
                                                            <div class="coment-head">
                                                                ...
                                                                <ins>
                                                                    <h5><a href="profil.php?id=<?php echo($COMMENT['IdUser'])?>" title="">
                                                         ...
                                                         <div class="description">
                                                            <p style="color: black; font-size: 16px;" ><?php echo htmlspecialchars($COMMENT['post']) ?>
                                                                <br><br>
